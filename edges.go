...
func Find_Escapee(points_map map[Key]Point) Key {
...
func check_is_edge(k Key, edgePoints chan Point, points_map map[Key]Point, width int, height int) {
...
func Find_Edges(edgePoints chan Point, points_map map[Key]Point, width int, height int) {
